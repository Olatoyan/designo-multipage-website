...
function Cta() {
  return (
    <section className="relative -mb-32 flex items-center justify-between rounded-[1.5rem] bg-[#e7816b] px-[9.5rem] py-24">
      <div>
        <h2 className="max-w-[26.8rem] pb-2 text-[4rem] font-medium leading-[100%] text-white">
